...
(function () {
  ...
  var SIGNAL_TOP_MARGIN = 30; // Top margin for first signal
  var SIGNAL_SPACING_MARGIN = 40; // Vertical spacing margin for each signal
  ...
  _.extend(BaseTheme.prototype, {
    ...
    draw_signals : function (offsetY) {
      var y = offsetY + SIGNAL_TOP_MARGIN;
      _.each(this.diagram.signals, function(s) {
        if (s.type == "Signal") {
          ...
          y += s.height + SIGNAL_SPACING_MARGIN;
